...
public class Recursion
{
	...
	// given a number count the number of 8 but if an 8 has another 8 to its immediate left count it as 2 
	...
	{	
		...
		return isSorted(array, i, count - 1);
	}
	...
	{	
		...
		{
			return isPalindrome(s.substring(lo + 1, hi), lo, hi - 2);
		}
		return false;
	}
} // END CLASS Recursion
